...
public class RestartChatService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "Chatting");
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            manager.createNotificationChannel(new NotificationChannel("Chatting", "Chatting Channel", NotificationManager.IMPORTANCE_NONE));
        }
